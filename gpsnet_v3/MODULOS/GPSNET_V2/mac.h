...
#define   mac_packet          gpsnet_packet.mac_packet_u
#define   nwk_packet          gpsnet_packet.nwk_packet_u
#define   app_packet          gpsnet_packet.app_packet_u
...
#define NEIGHBOR_PING_TIME   (INT16U)(1000/NUM_ALLOWED_CHANNELS) 
...
typedef struct _NWK_PACKET 
{
    ...
    INT8U         NWK_Parameter;
    INT8U         NWK_Dst_Lat[4];
    INT8U         NWK_Dst_Long[4];
    INT8U         NWK_Src_Lat[4];
    INT8U         NWK_Src_Long[4];
    INT8U         NWK_Better_Lat[4];
    INT8U         NWK_Better_Long[4];
#if(defined SUPPORT_APP_SEQNUMBER && SUPPORT_APP_SEQNUMBER == 1)
    INT8U         NWK_APP_SeqNumber; 
#else    
    INT8U         NWK_Route_Algorithm;
#endif    
...
extern  volatile GPSNET_PACKET      gpsnet_packet;
extern  volatile GPSNET_BEACON      gpsnet_beacon[BeaconLimit];
