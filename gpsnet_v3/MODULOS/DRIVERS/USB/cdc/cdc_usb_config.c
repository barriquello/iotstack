...
#define USB_VENDOR_ID   0xc1cau
#define USB_PRODUCT_ID  (0x4)
...
const hcc_u8 str_serail_number[10] = { 10, 0x3, 'V',0, '0',0, '.',0, '1',0};
const hcc_u8 str_product[70] = { 70, 0x3, 'U',0, 'S',0, 'B',0, ' ',0, 'C',0
                  , 'D',0, 'C',0, ' ',0, ' ',0, 'd',0, 'e',0, 'm',0, 'o',0
...
const hcc_u8 usb_config_descriptor[] = {
  USB_FILL_CFG_DESC(9+9+5+4+5+5+7+9+7+7, 2, 1, 4, CFGD_ATTR_BUS_PWR, 0xe0),
